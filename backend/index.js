        ...
        for (const side of sides) {
            for (const drink of drinks) {
                ...
                for (let i = 0; i < tastes.length; i++) {
                    ...
                    if (tasteCounts[taste]) {
                        tasteCounts[taste] += 1; // already exists, so increase count
                    } else {
                        tasteCounts[taste] = 1; // first time, so set count to 1
                    }
                }
                ...
                for (let taste in tasteCounts) {
                    if (tasteCounts[taste] > maxCount) {
                        maxCount = tasteCounts[taste];
                        tasteProfile = taste;
                    }
                }
